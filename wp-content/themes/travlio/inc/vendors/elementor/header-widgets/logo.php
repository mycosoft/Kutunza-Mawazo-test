...
class Travlio_Elementor_Logo extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Logo', 'travlio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'width',
            [
                'label' => esc_html__( 'Width Image', 'travlio' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Travlio_Elementor_Logo );