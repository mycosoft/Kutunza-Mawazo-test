...
class Travlio_Elementor_Features_Box extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Features Box', 'travlio' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Features Box', 'travlio' ),
        ...
        $repeater->add_control(
            'image_icon',
            [
                'label' => esc_html__( 'Image or Icon', 'travlio' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'icon' => esc_html__('Icon', 'travlio'),
                    'image' => esc_html__('Image', 'travlio'),
                ),
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control(
            'title_text',
            [
                'label' => esc_html__( 'Title & Description', 'travlio' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'This is the heading', 'travlio' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Description', 'travlio' ),
                'placeholder' => esc_html__( 'Enter your description', 'travlio' ),
                'separator' => 'none',
                'rows' => 10,
                'show_label' => false,
            ]
        ...
        $this->start_controls_section(
            'section_box_style',
            [
                'label' => esc_html__( 'Box Style', 'travlio' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Heading Style', 'travlio' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label' => esc_html__( 'Color Hover', 'travlio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            ...
            [
                'label' => esc_html__( 'Heading Typography', 'travlio' ),
        ...
        $this->start_controls_section(
            'section_icon_style',
            [
                'label' => esc_html__( 'Icon Style', 'travlio' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_tabs( 'tabs_icon_style' );
            ...
            $this->add_control(
                'icon_color',
                [
                    'label' => esc_html__( 'Icon Color', 'travlio' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        // Stronger selector to avoid section style from overwriting
            ...
            $this->add_control(
                'icon_hover_color',
                [
                    'label' => esc_html__( 'Icon Hover Color', 'travlio' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        // Stronger selector to avoid section style from overwriting
    ...
    protected function render() {
        ...
        if ( !empty($features) ) {
            ...
            <div class="widget-features-box <?php echo esc_attr($el_class.' '.$alignment.' '.$style); ?>">
                ...
                <?php }elseif($layout == 'grid'){  $item['number'] =1; $count = 1;?>  
                    <div class="row">
                        <?php foreach ($features as $item): ?>
                            <div class="item col-xs-<?php echo esc_attr( ($columns > 1)?6:12 ); ?> col-md-<?php echo esc_attr(12/$columns);?>
                                <?php echo esc_attr( ($count%2 == 1)?' sm-clearfix xs-clearfix ':''); ?>
                                <?php echo esc_attr( ($count%$columns == 1)?' lg-clearfix md-clearfix ':''); ?>
                                ">
...
Plugin::instance()->widgets_manager->register_widget_type( new Travlio_Elementor_Features_Box );