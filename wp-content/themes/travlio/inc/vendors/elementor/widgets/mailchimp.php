...
class Travlio_Elementor_Mailchimp extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus MailChimp Sign-Up Form', 'travlio' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'MailChimp Sign-Up Form', 'travlio' ),
        ...
        $this->add_control(
            'input_color',
            [
                'label' => esc_html__( 'Input Color', 'travlio' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Input Placeholder Color', 'travlio' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'input_bg_color',
            [
                'label' => esc_html__( 'Input Background', 'travlio' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Focus Color', 'travlio' ),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'border_border!' => '',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Box Shadow', 'travlio' ),
                'selector' => '{{WRAPPER}} input',
            ]
        );
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'btn_br_color',
                        [
                            'label' => esc_html__( 'Button Border', 'travlio' ),
                            'type' => Controls_Manager::COLOR,
...
Plugin::instance()->widgets_manager->register_widget_type( new Travlio_Elementor_Mailchimp );