...
class Travlio_Elementor_Instagram extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Instagram', 'travlio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Instagram', 'travlio' ),
        ...
        $this->add_control(
            'username',
            [
                'label' => esc_html__( 'Instagram Username', 'travlio' ),
                'type' => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Number images to display', 'travlio' ),
                'default' => 4
            ]
        );
        ...
        $this->add_control(
            'size',
            [
                'label' => esc_html__( 'Photo size', 'travlio' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'travlio'),
                    'small' => esc_html__('Small', 'travlio'),
                    'large' => esc_html__('Large', 'travlio'),
                    'original' => esc_html__('Original', 'travlio'),
                ),
                'default' => 'thumbnail'
            ]
        );
        ...
        $this->add_control(
            'target',
            [
                'label' => esc_html__( 'Open links in', 'travlio' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    '_self' => esc_html__('Current window (_self)', 'travlio'),
                    '_blank' => esc_html__('New window (_blank)', 'travlio'),
                ),
                'default' => 'grid'
            ]
        );
                ...
                <?php
                    ...
                    if ( $username != '' ) {
                        ...
                        if ( is_wp_error( $media_array ) ) {
                            ...
                            if ( $images_only = apply_filters( 'travlio_instagram_element_images_only', false ) ) {
...
Plugin::instance()->widgets_manager->register_widget_type( new Travlio_Elementor_Instagram );