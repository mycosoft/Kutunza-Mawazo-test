...
<div class="apus-social-share">
		...
		<strong><?php echo esc_html__('Share Link','travlio'); ?> </strong>
		<?php if ( travlio_get_config('facebook_share', 1) ): ?>
		...
		<?php endif; ?>
		<?php if ( travlio_get_config('twitter_share', 1) ): ?>
 			<a href="javascript:void(0);" data-original-title="twitter" class="bo-social-twitter addthis_button_twitter"><i class="fab fa-twitter"></i></a>
		<?php endif; ?>
		<?php if ( travlio_get_config('linkedin_share', 1) ): ?>
		...
		<?php if ( travlio_get_config('pinterest_share', 1) ): ?>
		...
		<?php if ( travlio_get_config('more_share', 1) ): ?>
