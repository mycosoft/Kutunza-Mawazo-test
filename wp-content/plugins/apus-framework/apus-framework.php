 ...
 * Description:     framework for wordpress theme
 * Author:          Myco Kagame
...
define( 'APUS_FRAMEWORK_VERSION', '2.2');
 ...
 *
 */
if ( !class_exists( 'ReduxFramework' ) && file_exists( APUS_FRAMEWORK_DIR . 'libs/redux/redux-core/framework.php' ) ) {
    require_once( APUS_FRAMEWORK_DIR . 'libs/redux/redux-core/framework.php' );
