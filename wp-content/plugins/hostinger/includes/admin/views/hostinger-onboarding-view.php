...
<div class="hsr-onboarding-navbar">
	<div class="hsr-onboarding-navbar__wrapper">
		<ul class="hsr-wrapper__list">
			...
			<?php endif; ?>
			<?php if ( ! empty( Hostinger_Helper::get_api_token() ) ) : ?>
			...
			<div class="hts-container">
				<div class="hts-content">
					...
					<div class="hts-btn-wrapper">
						...
						<div class="hts-response-msg"><?php echo esc_html( __('Success! You will be notified when the new feature is available.', 'hostinger') ) ?></div>
					</div>
				</div>
			</div>
		</div>
...
<?php
	if ( $survey->is_survey_enabled() ): ?>
		<div class="hts-survey-wrapper">
			<div id="hostinger-feedback-survey"></div>
			<div id="hts-questionsLeft">
				<span id="hts-currentQuestion">1</span> <?php _e( 'Question', 'hostinger' ); ?> <?php _e( 'of ', 'hostinger' ); ?>
